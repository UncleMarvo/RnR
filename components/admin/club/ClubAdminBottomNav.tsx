...
const tabs = [
  { label: "Home", icon: Home, href: "/club-admin/dashboard" },
  { label: "Members", icon: Users, href: "/club-admin/members" },
  { label: "Invites", icon: Mail, href: "/club-admin/invites" },
  { label: "Orders", icon: Package, href: "/club-admin/orders" },
]

const moreLinks = [
  { label: "Revenue Share", icon: Banknote, href: "/club-admin/revenue" },
  { label: "Settings", icon: Settings, href: "/club-admin/settings" },
]

export function ClubAdminBottomNav() {
